...
import com.otclub.humate.domain.chat.dto.CompanionStartRequestDTO;
...
public class CompanionController {
    ...
    @PostMapping("/start")
    public ResponseEntity<CommonResponseDTO> companionStart(@RequestBody CompanionStartRequestDTO chatRoomId,
